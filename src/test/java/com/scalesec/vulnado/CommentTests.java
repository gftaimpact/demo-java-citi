...
public class CommentTest {
    ...
    @Test
    public void create_ShouldThrowServerError_WhenCommitFails() {
        String username = "testUser";
        String body = "testBody";
    ...
    @Test
    public void commit_ShouldReturnTrue_WhenCommentIsValid() throws SQLException {
        String id = UUID.randomUUID().toString();
        String username = "testUser";
        String body = "testBody";
    ...
    @Test
    public void commit_ShouldThrowSQLException_WhenCommentIsInvalid() {
        String id = UUID.randomUUID().toString();
        String username = "testUser";
        String body = "testBody";
        long time = new Date().getTime();
