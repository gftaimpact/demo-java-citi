...
public class UserTest {
    ...
    @Test
    public void fetch_ShouldThrowException_WhenSQLExceptionOccurs() throws Exception {
        String username = "testUser";
        Connection mockConnection = Mockito.mock(Connection.class);
        PreparedStatement mockPreparedStatement = Mockito.mock(PreparedStatement.class);
        ...
        Postgres.setConnection(mockConnection);
        assertThrows(SQLException.class, () -> User.fetch(username), "Exception should be thrown when SQLException occurs");
    }
}
